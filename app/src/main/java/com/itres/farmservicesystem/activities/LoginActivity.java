                ...
                .addOnCompleteListener( LoginActivity.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            ...
                            startActivity( new Intent(LoginActivity.this,MainActivity.class) );//go to the main Activity
                        }
                        else{
                            Toast.makeText( LoginActivity.this, "Error!!"+task.getException(), Toast.LENGTH_SHORT ).show();//error with reason
                        }
                    }
                } );
    }
